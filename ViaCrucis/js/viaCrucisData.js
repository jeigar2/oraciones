const viaCrucisData = [
  ...
  },
  {
    ...
    imagen:"quinta_estación-001.jpg"
  },
  {
    numero: 6,
    estacion: "Sexta Estación",
    titulo: "Verónica limpia el rostro de Jesús",
    cita: "Dice el profeta Isaías: «No tenía apariencia ni presencia; lo vimos y no tenía aspecto que pudiésemos estimar. Despreciable y desecho de hombres, varón de dolores y sabedor de dolencias, como uno ante quien se oculta el rostro, despreciable, y no lo tuvimos en cuenta». Es la descripción profética de la figura de Jesús camino del Calvario, con el rostro desfigurado por el sufrimiento, la sangre, los salivazos, el polvo, el sudor... Entonces, una mujer del pueblo, Verónica de nombre, se abrió paso entre la muchedumbre llevando un lienzo con el que limpió piadosamente el rostro de Jesús. El Señor, como respuesta de gratitud, le dejó grabada en él su Santa Faz.",
    reflexion: 
        [
            "Una letrilla tradicional de esta sexta estación nos dice: «Imita la compasión / de Verónica y su manto / si de Cristo el rostro santo / quieres en tu corazón». Nosotros podemos repetir hoy el gesto de la Verónica en el rostro de Cristo que se nos hace presente en tantos hermanos nuestros que comparten de diversas maneras la pasión del Señor, quien nos recuerda: «Lo que hagáis con uno de estos, mis pequeños, conmigo lo hacéis». <span class='cita'>(Mt 25, 40).</span>"
        ],
    poema: 
        [
  ...
  },
  {
    ...
    imagen:"octava_estación-001.jpg"
  },
  {
    numero: 9,
    estacion: "Novena Estación",
    titulo: "Jesús cae por tercera vez",
    cita: "Una vez llegado al Calvario, en la cercanía inmediata del punto en que iba a ser crucificado, Jesús cayó por tercera vez, exhausto y sin arrestos ya para levantarse. Las condiciones en que venía y la continua subida lo habían dejado sin aliento. Había mantenido su decisión de secundar los planes de Dios, a los que servían los planes de los hombres, y así había alcanzado, aunque con un total agotamiento, los pies del altar en que había de ser inmolado",
    reflexion: 
        [
  ...
  },
  {
    ...
    imagen:"décima_estación-001.jpg"
  },
  {
    numero: 11,
    estacion: "Undécima Estación",
    titulo: "Jesús es clavado en la cruz",
    cita: "«Y lo crucificaron», dicen escuetamente los evangelistas. Había llegado el momento terrible de la crucifixión, y Jesús fue fijado en la cruz con cuatro clavos de hierro que le taladraban las manos y los pies. Levantaron la cruz en alto y el cuerpo de Cristo quedó entre cielo y tierra, pendiente de los clavos y apoyado en un saliente que había a mitad del palo vertical. En la parte superior de este palo, encima de la cabeza de Jesús, pusieron el título o causa de la condenación: «Jesús el Nazareno, el Rey de los judíos». También crucificaron con él a dos ladrones, uno a su derecha y el otro a su izquierda.",
    reflexion: 
        [
    ...
    imagen:"undécima_estación-001.jpg"
  },
  {
    numero: 12,
    estacion: "Duodécima Estación",
  ...
  },
  {
    ...
    imagen:"decimocuarta_estación-001.jpg"
  }
];

const oracionesComunes = {
